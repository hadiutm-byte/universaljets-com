      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        <DialogContent className="bg-card border-border/30 max-w-lg max-h-[85vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-2">
            ...
            <button type="submit" className="w-full py-3 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-lg hover:shadow-[0_0_30px_-8px_hsla(43,85%,58%,0.45)] transition-all duration-500">Create</button>
          </form>
        </DialogContent>
      </Dialog>
    </div>
