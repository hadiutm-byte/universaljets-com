...
const HRPage = () => {
  ...
  useEffect(() => {
    const load = async () => {
      // Get all user_roles that are staff
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-xl font-display font-semibold">Staff Directory</h1>
        <p className="text-[11px] text-muted-foreground/50 font-light mt-1">Internal team records, roles, and departments</p>
      </div>
