                    ...
                    <motion.div key="s2" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} className="space-y-5">
                          ...
                          {TIERS.map(t => (
                            <button key={t.key} type="button" onClick={() => setSelectedTier(t.key)}
                              className={`p-4 rounded-xl border text-left transition-all duration-300 ${
                                selectedTier === t.key
                                  ? "border-primary bg-primary/5 shadow-[0_0_20px_-5px_hsla(45,79%,46%,0.15)]"
                      ...
                      <div className="flex gap-3">
                        ...
                        <button type="button" disabled={!canStep2} onClick={() => setStep(3)}
                          className="flex-1 py-3.5 bg-gradient-gold text-primary-foreground text-[10px] tracking-[0.25em] uppercase font-medium rounded-lg transition-all duration-500 hover:shadow-[0_0_40px_-10px_hsla(45,79%,46%,0.4)] disabled:opacity-40 btn-luxury">Continue</button>
                      </div>
                    </motion.div>
                  )}
                    ...
                    <motion.div key="s3" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} className="space-y-5">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button type="button" onClick={() => setStep(4)}
                          className="flex-1 py-3.5 bg-gradient-gold text-primary-foreground text-[10px] tracking-[0.25em] uppercase font-medium rounded-lg transition-all duration-500 hover:shadow-[0_0_40px_-10px_hsla(45,79%,46%,0.4)] btn-luxury">Continue</button>
                      </div>
                    </motion.div>
                  )}
