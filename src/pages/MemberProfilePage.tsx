          ...
          <Tabs defaultValue="overview" className="w-full">
            ...
            <TabsContent value="personal">
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass rounded-xl p-6 space-y-4">
                ...
                <button onClick={saveProfile} disabled={saving} className="mt-4 px-6 py-2.5 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-lg hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.45)] transition-all duration-500 disabled:opacity-50 inline-flex items-center gap-2">
            ...
            <TabsContent value="travel">
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass rounded-xl p-6 space-y-4">
                ...
                <button onClick={saveTravel} disabled={saving} className="mt-4 px-6 py-2.5 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-lg hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.45)] transition-all duration-500 disabled:opacity-50 inline-flex items-center gap-2">
            ...
            <TabsContent value="billing">
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                <div className="glass rounded-xl p-6 space-y-4">
                  ...
                  <button onClick={saveProfile} disabled={saving} className="px-6 py-2.5 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-lg hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.45)] transition-all disabled:opacity-50 inline-flex items-center gap-2">
                    <Save size={12} /> Save
                  </button>
                </div>
                <div className="glass rounded-xl p-6">
            ...
            <TabsContent value="concierge">
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass rounded-xl p-6 space-y-4">
                ...
                <button onClick={saveConcierge} disabled={saving} className="px-6 py-2.5 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-lg hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.45)] transition-all disabled:opacity-50 inline-flex items-center gap-2">
                  <Save size={12} /> {saving ? "Saving..." : "Save Preferences"}
                </button>
              </motion.div>
            </TabsContent>
