...
const PartnerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      <SEOHead title="Partner With Universal Jets — Luxury Brand Collaboration" description="Partner with Universal Jets. Opportunities for luxury hotels, ground transport, lifestyle brands, and travel management companies." path="/partners" />
