    ...
    <div className="min-h-screen bg-background relative">
      ...
      <div className="relative z-[2]">
        ...
        <section className="pt-40 pb-24 relative">
          <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: "radial-gradient(ellipse 50% 40% at 50% 30%, hsla(38,52%,53%,0.3) 0%, transparent 70%)" }} />
                  ...
                  <motion.div key={card.type} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15, duration: 0.7 }}
                    ...
                    <div className="relative rounded-xl overflow-hidden aspect-[1.586/1] mb-8 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.5)]"
                      ...
                      <motion.div className="absolute inset-0 opacity-[0.08]" animate={{ backgroundPosition: ["0% 0%", "200% 200%"] }} transition={{ duration: 6, repeat: Infinity, ease: "linear" }}
                        style={{ backgroundImage: "linear-gradient(135deg, transparent 25%, hsla(38,52%,53%,0.4) 35%, transparent 45%)", backgroundSize: "200% 200%" }} />
                      <div className="relative z-10 p-6 h-full flex flex-col justify-between">
                        ...
                        <div>
                          <div className="flex items-center gap-3 mb-3">
                            <div className="w-8 h-6 rounded-[3px] border border-primary/20" style={{ background: "linear-gradient(145deg, hsla(38,52%,53%,0.2) 0%, hsla(38,52%,53%,0.08) 100%)" }}>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button type="submit" disabled={loading}
                    className="w-full py-4 bg-gradient-gold text-primary-foreground text-[10px] tracking-[0.3em] uppercase font-medium rounded-lg transition-all duration-500 hover:shadow-[0_0_40px_-10px_hsla(38,52%,53%,0.4)] hover:scale-[1.01] disabled:opacity-50">
