        ...
        <div className="container mx-auto px-8 max-w-sm">
          ...
          >
            <p className="text-[9px] tracking-[0.5em] uppercase text-gold/70 mb-6 font-light">
              {isForgotPassword ? "Account Recovery" : isLogin ? "Welcome Back" : "Private Access"}
            </p>
            <h1 className="text-2xl md:text-3xl font-display font-semibold">
              {isForgotPassword ? "Reset Password" : isLogin ? "Sign In" : "Apply for Membership"}
            </h1>
          ...
          >
            {isForgotPassword ? (
              <form onSubmit={handleForgotPassword} className="space-y-4">
                <p className="text-[11px] text-foreground/40 font-light leading-relaxed mb-4">
                ...
                <form onSubmit={handleEmailAuth} className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-[9px] tracking-[0.25em] uppercase text-gold/50 font-light">
                        Password
                      </label>
                      {isLogin && (
                        <button
                          ...
                          className="text-[9px] text-foreground/30 hover:text-gold/60 transition-colors font-light"
                        >
                          Forgot password?
                        </button>
                      )}
