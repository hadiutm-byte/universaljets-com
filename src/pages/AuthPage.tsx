        ...
        <div className="container mx-auto px-8 max-w-sm">
          ...
          >
            <p className="text-[9px] tracking-[0.5em] uppercase text-gold/70 mb-6 font-light">
              {isLogin ? "Welcome Back" : "Join Universal Jets"}
            </p>
          ...
          >
            ...
            <button
              ...
              className="w-full py-3 luxury-border rounded-lg text-[11px] tracking-[0.15em] uppercase font-light text-foreground/60 hover:text-foreground/90 hover:border-gold/30 transition-all duration-500 flex items-center justify-center gap-3 mb-6"
            >
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-lg hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.45)] transition-all duration-500 mt-2 disabled:opacity-50"
              >
