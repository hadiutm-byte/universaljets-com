...
const EmptyLegPopup = ({ leg, onClose }: EmptyLegPopupProps) => {
  ...
  const shareData = { fromCode, fromCity, toCode, toCity, date, price: priceLabel, aircraftType: leg.aircraft_type || "Private Jet", category, aircraftImage: image, maxPax: leg.aircraft_max_pax };
