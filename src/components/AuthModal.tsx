            ...
            <div className="p-8 pt-10">
              ...
              <div className="text-center mb-8">
                ...
                <h3 className="text-xl font-display font-semibold text-white/90 mb-2">
                  {mode === "signup" ? "Request Invitation" : mode === "forgot" ? "Reset Password" : "Welcome Back"}
                </h3>
              ...
              {mode === "forgot" ? (
                <form onSubmit={handleForgotPassword} className="space-y-3.5">
                  ...
                  <p className="text-center text-[10px] text-white/25 font-extralight mt-4">
                    <button
                      type="button"
                  ...
                  <form onSubmit={handleEmailAuth} className="space-y-3.5">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1.5">
                        <label className="text-[8px] tracking-[0.3em] uppercase text-[hsl(43,74%,49%,0.5)] font-light">
                          Password
                        </label>
                        {mode === "login" && (
                          <button
                            ...
                            className="text-[9px] text-white/20 hover:text-[hsl(43,74%,49%,0.6)] transition-colors font-light cursor-pointer"
                          >
                            Forgot password?
                          </button>
                        )}
