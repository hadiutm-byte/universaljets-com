  ...
  <section className="section-padding relative overflow-hidden">
    ...
    <div className="container mx-auto px-8 relative z-10">
        ...
        {tiers.map((tier, i) => (
          <motion.div
            ...
            className={`relative rounded-2xl p-8 md:p-10 flex flex-col transition-all duration-700 group ${
              tier.highlighted
                ? "glass border border-gold/20 shadow-[0_0_40px_-12px_hsla(43,85%,58%,0.15)]"
          ...
          >
            ...
            <Link
              ...
              className={`inline-flex items-center justify-center gap-2 w-full py-3.5 rounded-sm text-[9px] tracking-[0.25em] uppercase font-medium transition-all duration-500 ${
                tier.highlighted
                  ? "bg-gradient-gold text-primary-foreground hover:shadow-[0_0_30px_-8px_hsla(43,85%,58%,0.45)]"
      ...
      >
        ...
        <Link
          to="/#cta"
          className="inline-flex items-center gap-2 px-10 py-3.5 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-sm hover:shadow-[0_0_30px_-8px_hsla(43,85%,58%,0.45)] transition-all duration-500"
        >
