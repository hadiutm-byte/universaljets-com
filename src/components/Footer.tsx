    ...
    <div className="flex gap-4 mb-8">
      {socials.map((s) => (
        <motion.a
          ...
          className="flex items-center justify-center w-10 h-10 rounded-full bg-white/5 border border-white/10 text-primary hover:bg-primary hover:text-white hover:shadow-[0_8px_25px_-5px_hsla(45,79%,46%,0.3)] transition-all duration-300"
        >
