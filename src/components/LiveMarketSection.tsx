      ...
      <div className="container mx-auto px-8 relative z-10">
        ...
        <FadeReveal delay={0.4} className="text-center pt-10">
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-3 px-10 py-4 bg-gradient-gold text-primary-foreground text-[10px] tracking-[0.3em] uppercase font-medium rounded-xl transition-all duration-500 hover:shadow-[0_0_40px_-10px_hsla(43,74%,49%,0.4)]"
          >
            Request Your Flight
