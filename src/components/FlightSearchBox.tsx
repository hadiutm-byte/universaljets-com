  ...
  return (
    ...
    >
      ...
      <div className="search-card-futuristic relative rounded-3xl overflow-hidden group/search transition-all duration-500 hover:shadow-[0_0_40px_-8px_hsl(var(--primary)/0.3)]">
        ...
        <div className="absolute inset-[1px] rounded-[23px] bg-[hsl(var(--charcoal-deep)/0.97)] backdrop-blur-3xl transition-[backdrop-filter] duration-500 group-hover/search:backdrop-blur-[30px]" />
