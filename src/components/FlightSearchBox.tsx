...
const FlightSearchBox = () => {
  ...
  return (
    ...
    >
      ...
      {/* ── Search Card ── */}
      <div className="search-card-futuristic relative rounded-3xl overflow-hidden">
        {/* Ambient glow border */}
        ...
        <div className="absolute inset-[1px] rounded-[23px] bg-background/95 backdrop-blur-3xl" />
