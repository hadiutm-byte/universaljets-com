        ...
        <>
          ...
          {!open && (
            <motion.button
              ...
              className="fixed bottom-6 right-6 z-[45] w-16 h-16 rounded-full overflow-hidden shadow-[0_0_25px_-5px_hsla(43,85%,58%,0.4)] hover:shadow-[0_0_35px_-5px_hsla(43,85%,58%,0.6)] transition-shadow duration-500 group"
              aria-label="Chat with Ricky"
            >
              <div className="absolute inset-0 rounded-full animate-pulse-glow pointer-events-none" style={{ boxShadow: "0 0 20px 4px hsla(43,85%,58%,0.25)" }} />
              <img
                src={rickyIdle}
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="fixed bottom-6 right-6 z-[45] w-[360px] max-w-[calc(100vw-2rem)] h-[520px] max-h-[calc(100vh-3rem)] flex flex-col rounded-2xl overflow-hidden border border-gold/10 shadow-[0_0_50px_-12px_hsla(43,85%,58%,0.2)]"
                ...
                <div className="px-4 py-3 border-t border-white/5">
                  <div className="flex items-center gap-2 bg-white/5 rounded-xl px-4 py-2.5 focus-within:ring-1 focus-within:ring-gold/20 transition-all">
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-gold text-primary-foreground disabled:opacity-30 hover:shadow-[0_0_15px_-3px_hsla(43,85%,58%,0.4)] transition-all duration-300"
                    >
                      <Send size={12} />
                    </button>
                  </div>
