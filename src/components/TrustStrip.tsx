        ...
        <div className="flex items-center gap-4">
          {socials.map((s) => (
            <motion.a
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full bg-background border border-border text-primary hover:bg-primary hover:text-white hover:shadow-[0_8px_25px_-5px_hsla(43,85%,58%,0.3)] transition-all duration-300"
            >
