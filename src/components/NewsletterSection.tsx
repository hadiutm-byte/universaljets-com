              ...
              <div className="space-y-3">
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="px-8 py-3.5 bg-gradient-gold text-primary-foreground text-[10px] tracking-[0.25em] uppercase font-medium rounded-lg transition-all duration-500 hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.4)] hover:scale-[1.01] disabled:opacity-40 whitespace-nowrap btn-luxury"
                  >
