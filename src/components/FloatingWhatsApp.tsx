...
const FloatingWhatsApp = () => (
  <motion.a
    ...
    whileTap={{ scale: 0.95 }}
    className="fixed bottom-6 right-24 z-40 w-12 h-12 rounded-full bg-[hsl(220,10%,12%)] border border-white/10 shadow-[0_4px_20px_hsla(0,0%,0%,0.4)] flex items-center justify-center group transition-shadow hover:shadow-[0_0_20px_-4px_hsla(45,79%,46%,0.25)]"
