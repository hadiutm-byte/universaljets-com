    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-4">
        <AnimatePresence mode="wait">
          {/* STEP 0 — Trip Type */}
          {step === 0 && (
            <motion.div key="trip" variants={containerVariants} initial="hidden" animate="visible" exit="exit" className="space-y-2">
              {tripOptions.map((opt) => (
                <motion.button
                  key={opt.value}
          ...
          {/* STEP 1 — Route */}
          {step === 1 && (
            <motion.div key="route" variants={containerVariants} initial="hidden" animate="visible" exit="exit" className="space-y-1">
          ...
          {/* STEP 2 — Date & Time */}
          {step === 2 && (
            <motion.div key="date" variants={containerVariants} initial="hidden" animate="visible" exit="exit" className="space-y-2">
              <div className="rounded-xl border border-white/[0.04] bg-white/[0.02] overflow-hidden">
                <DateTimePicker
                  label="Departure"
                  icon={Calendar}
          ...
          {/* STEP 3 — Passengers */}
          {step === 3 && (
            <motion.div key="pax" variants={containerVariants} initial="hidden" animate="visible" exit="exit">
          ...
          {/* STEP 4 — Preference */}
          {step === 4 && (
            <motion.div key="pref" variants={containerVariants} initial="hidden" animate="visible" exit="exit" className="space-y-2">
              {prefOptions.map((opt) => (
                <motion.button
                  key={opt.value}
                  whileHover={{ scale: 1.01 }}
          ...
          {/* STEP 5 — Summary */}
          {step === 5 && (
            <motion.div key="summary" variants={containerVariants} initial="hidden" animate="visible" exit="exit">
