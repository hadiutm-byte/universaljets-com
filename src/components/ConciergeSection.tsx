    ...
    <div className="container mx-auto px-8 relative z-10">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-5xl mx-auto">
        {items.map((item, i) => (
          ...
          >
            <div className="w-16 h-16 rounded-full border border-border flex items-center justify-center mx-auto mb-8 group-hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.15)] transition-all duration-700">
