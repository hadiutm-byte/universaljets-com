      ...
      {visible && (
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => accept("all")}
              className="flex-1 py-2.5 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-sm transition-all duration-500 hover:shadow-[0_0_30px_-8px_hsla(38,52%,50%,0.4)]"
            >
              Accept All
            </button>
            <button
