    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="text-[11px] md:text-[12px] tracking-[0.55em] uppercase text-primary mb-10 font-light"
        >
        ...
        >
          <p className="text-[16px] md:text-[18px] text-muted-foreground font-light leading-[2] tracking-[0.01em] mb-2">
            Access the entire global private jet market —
            <br className="hidden sm:block" />
            not just one fleet.
          </p>
          <p className="text-[14px] md:text-[15px] text-muted-foreground/70 font-light leading-[1.8]">
        ...
        >
          <motion.button
            ...
            className="btn-luxury px-10 py-4 bg-gradient-gold text-white text-[11px] tracking-[0.25em] uppercase font-medium rounded-xl cursor-pointer flex items-center gap-3"
          >
            Request a Flight
          ...
          <a
            href="#empty-legs"
            className="btn-luxury px-10 py-4 border border-border bg-background hover:bg-muted text-foreground/60 hover:text-foreground text-[11px] tracking-[0.25em] uppercase font-light rounded-xl transition-all duration-300"
          >
            View Empty Legs
          </a>
        </motion.div>
      ...
      >
        <span className="text-[8px] tracking-[0.4em] uppercase text-muted-foreground/40 font-extralight">Scroll</span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
          transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
          className="w-[1px] h-8 bg-gradient-to-b from-primary/20 to-transparent"
        />
      </motion.div>
    </section>
  );
