      ...
      <DialogContent className="bg-card border-border/30 max-w-2xl max-h-[85vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="mt-2">
          ...
          <button type="submit" disabled={loading}
            className="w-full mt-6 py-3 bg-gradient-gold text-primary-foreground text-[9px] tracking-[0.25em] uppercase font-medium rounded-lg hover:shadow-[0_0_30px_-8px_hsla(45,79%,46%,0.45)] transition-all duration-500 disabled:opacity-50">
