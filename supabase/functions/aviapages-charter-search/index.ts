...
const AIRPORT_COORDS: Record<string, [number, number]> = {
  ...
  LEAL:[38.28,-0.56],LEZL:[37.42,-5.89],
  LPPT:[38.77,-9.13],LPFR:[37.01,-7.97],
  EHAM:[52.31,4.76],EBBR:[50.90,4.48],
  LOWW:[48.11,16.57],LOWI:[47.26,11.34],LOWS:[47.79,13.00],
  ...
  GMMN:[33.37,-7.59],UUEE:[55.97,37.41],UUDD:[55.41,37.91],
  // === MIDDLE EAST ===
  ...
  OETF:[21.48,40.54],OEGT:[26.30,50.16],OEGS:[17.61,44.07],OERY:[24.71,46.73],
  OBBI:[26.27,50.63],OKBK:[29.23,47.97],OOMS:[23.59,58.28],OOSA:[17.04,54.09],
  LLBG:[32.01,34.88],OJAI:[31.72,35.99],OJAQ:[29.61,35.02],OJMF:[32.36,36.26],
  OLBA:[33.82,35.49],OSDI:[33.41,36.52],OSAP:[36.18,37.22],
  ORBI:[33.26,44.23],ORMM:[30.55,47.66],ORNI:[36.60,42.45],
  OIYY:[30.12,48.23],OIKK:[29.97,50.83],OIIE:[35.68,51.31],OICC:[34.35,47.16],
  ...
  VNKT:[27.70,85.36],OPLA:[31.52,74.40],OPRN:[33.62,73.10],OPKC:[24.91,67.16],
  // === SOUTHEAST ASIA ===
  ...
  VDPP:[11.55,104.84],VLVT:[17.99,102.56],VBRY:[16.79,96.13],VYYY:[16.90,96.13],
  RPLL:[14.51,121.02],RPMD:[7.13,125.65],RPVM:[10.31,123.98],
  // === EAST ASIA ===
  VHHH:[22.31,113.91],VMMC:[22.15,113.59],
  ...
  YPAD:[-34.94,138.53],YSCB:[-35.31,149.19],YBCG:[-28.16,153.50],YBTL:[-19.25,146.77],
  ...
  // === RUSSIA / CIS ===
  ULLI:[59.80,30.26],UUWW:[55.60,37.27],UGTB:[41.67,44.95],UGEE:[40.01,44.34],
};
